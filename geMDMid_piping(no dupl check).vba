...
'유저폼에서 입력한 값을 변수에 저장
    ...
    '프로시저 실행
    Module1.CreateMDMID2 HeaderRow, MDMIDCol, FluidCol, SerialNoCol, SizeCol, MaterialCodeCol, InsulationCodeCol, TracingCol, JacketCodeCol
...
Sub CreateMDMID2(HeaderRow As Integer, MDMIDCol As Integer, FluidCol As Integer, SerialNoCol As Integer, SizeCol As Integer, MaterialCodeCol As Integer, InsulationCodeCol As Integer, TracingCol As Integer, JacketCodeCol As Integer)
